...
4. Note that adding the environment variable for the mongodb service should be done in docker-compose.yml and not in the Docker file (see the example below).
